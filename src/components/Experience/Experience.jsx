  ...
  return (
    <div className="experience" id='experience'>
      ...
      <div className="achievement">
        ...
        <span  style={{color: darkMode?'white':''}}>competitons  </span>
        <span>attended & conq</span>
         
      {/* </div>
      <div className="achievement">
        <div className="circle" style={{color: darkMode?'var(--orange)':''}}>4+</div>
        <span  style={{color: darkMode?'white':''}}>volunteering
  </span>
        <span>task completed </span> */}
      </div>
      <div className="achievement">
        <div className="circle" style={{color: darkMode?'var(--orange)':''}}>2+</div>
        <span  style={{color: darkMode?'white':''}}>club lead  </span>
        <span>handled  </span>
      </div>
    </div>
  );
